...
const MODULES = [
  ...
  {
    id: "filmPresets",
    file: "scripts/filmPresets.js",
    imports: {
      "state": "state.state",
      "emit": "state.emit",
    },
    exports: [
      "initFilmStore", "getFilms", "getFilmTargetTag", "getFilmIsoTag",
      "setFilmTargetTag", "addFilm", "removeFilm", "renamFilm", "reorderFilm",
      "resetFilmsToDefault", "hardClearFilms", "getDefaultFilms",
      "exportFilmJson", "importFilmJson", "mergeFilms",
    ],
  },
  {
    id: "ui",
    ...
    exports: [
      ...
      "renderFilmCards", "renderFilmList",
    ],
  },
  {
    id: "version",
  ...
  },
  {
    ...
    imports: {
      ...
      "initFilmStore": "filmPresets.initFilmStore",
      "addFilm": "filmPresets.addFilm",
      "removeFilm": "filmPresets.removeFilm",
      "renamFilm": "filmPresets.renamFilm",
      "reorderFilm": "filmPresets.reorderFilm",
      "resetFilmsToDefault": "filmPresets.resetFilmsToDefault",
      "hardClearFilms": "filmPresets.hardClearFilms",
      "getDefaultFilms": "filmPresets.getDefaultFilms",
      "exportFilmJson": "filmPresets.exportFilmJson",
      "importFilmJson": "filmPresets.importFilmJson",
      "mergeFilms": "filmPresets.mergeFilms",
      "getFilmTargetTag": "filmPresets.getFilmTargetTag",
      "getFilmIsoTag": "filmPresets.getFilmIsoTag",
      "setFilmTargetTag": "filmPresets.setFilmTargetTag",
      ...
      "renderFilmCards": "ui.renderFilmCards",
    },
    exports: [],
  },
];
